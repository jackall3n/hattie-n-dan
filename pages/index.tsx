export default function Home() {
  const accommodation = [
    ...
    },
    {
      ...
      subtitle: "10/09/22 - Saturday @ 3:30pm. Dress code: Cocktail attire",
      description:
  ...
  return (
    <>
      ...
      <div className="py-10 grid gap-10 lg:gap-10 font-cormorant">
        {accommodation.map(
          ({ image, subtitle, description, title, contact }, index) => (
            <div
              key={index}
            ...
            >
              ...
              <div className="text-left md:p-0 p-5">
                ...
                <h4 className="font-cormorant text-base">{subtitle}</h4>
